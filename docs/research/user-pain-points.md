...
| PP-T5 | **Feels surveilled** — GPS used for discipline, "constant surveillance"; hurts morale *and* data quality | **P1** | Med | 23% of monitored workers feel watched; tracking "breeds resentment"; **1 in 3 employees say monitoring hurt their mental health**; Hubstaff (the surveillance archetype) "creates trust issues, decreased morale… micromanagement" ([fieldservicely](https://www.fieldservicely.com/blog/how-to-track-field-employees-without-micromanaging), [memtime](https://www.memtime.com/blog/is-time-tracking-micromanagement), [Hubstaff stats](https://hubstaff.com/blog/employee-monitoring-statistics/), [trackingtime](https://trackingtime.co/is-hubstaff-invasive)) | **Trust-first, not surveillance-first** — keep GPS (it's table stakes) but purpose-bound & transparent (the [tracking bright line](../15-transparency-and-control.md)) + the [private personal layer](../16-notes-and-reflection.md) ([strategy](../01-product-strategy.md)) |
